          ...
          <div className="grid grid-cols-2 gap-3.5 w-full">
            {availableLanguages.map((l) => (
              <motion.button
                ...
                className="bg-white/95 hover:bg-slate-50/50 py-3 px-4 rounded-xl border border-slate-200/80 flex flex-col items-center justify-center transition-all shadow-sm hover:shadow-md group"
              >
